...
type CfgTag struct {
	...
	Tag  []byte          `protobuf:"bytes,2,opt,name=tag,proto3" json:"tag,omitempty"`                                      // 配置文件的配置标识，tag值为空则没有此配置
}
...
var file_capwap_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x74, 0x61, 0x67, 0x22, 0x6e,
