...
const (
	CfgTagType_Globel  CfgTagType = 0 // 所有配置的唯一标识
	CfgTagType_CfgNtp  CfgTagType = 1 // ntp配置文件的标识
	CfgTagType_CfgLog  CfgTagType = 2 // log配置文件的标识
	CfgTagType_CfgPcap CfgTagType = 3 // pcap配置标识
)
...
type MsgHeader struct {
	...
	Mac     string      `protobuf:"bytes,7,opt,name=mac,proto3" json:"mac,omitempty"`                                     // 客户端->OMC的消息必须携带此参数，若客户端设备为动态IP地址，必须携带此参数标识消息包归属哪个设备
}
...
type PortStatistics struct {
	...
	Status int32  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"` // 端口状态，0：down，1：up
	RxRate uint64 `protobuf:"varint,3,opt,name=rxRate,proto3" json:"rxRate,omitempty"` // 端口接收速率
	TxRate uint64 `protobuf:"varint,4,opt,name=txRate,proto3" json:"txRate,omitempty"` // 端口发送速率
}
...
type WlanLinkStatus struct {
	...
	Rsrp     int32  `protobuf:"varint,3,opt,name=rsrp,proto3" json:"rsrp,omitempty"`         // 信号强度
	Rssi     int32  `protobuf:"varint,4,opt,name=rssi,proto3" json:"rssi,omitempty"`         // 信噪比
	RxRate   int32  `protobuf:"varint,5,opt,name=rxRate,proto3" json:"rxRate,omitempty"`     // 协商速率
	TxRate   int32  `protobuf:"varint,6,opt,name=txRate,proto3" json:"txRate,omitempty"`     // 协商速率
	Mac      string `protobuf:"bytes,7,opt,name=mac,proto3" json:"mac,omitempty"`            // sta看到AP的essid-mac，AP看到sta的mac
	Essid    string `protobuf:"bytes,8,opt,name=essid,proto3" json:"essid,omitempty"`        // ap广播的ssid名称，sta接入的apssid名称
}
...
func (x *WlanLinkStatus) GetRssi() int32 {
	if x != nil {
		return x.Rssi
	}
	return 0
...
func (x *WlanLinkStatus) GetRxRate() int32 {
	if x != nil {
		return x.RxRate
	}
	return 0
...
func (x *WlanLinkStatus) GetTxRate() int32 {
	if x != nil {
		return x.TxRate
	}
	return 0
...
func (x *WlanLinkStatus) GetEssid() string {
	if x != nil {
		return x.Essid
	}
	return ""
...
type MsgHbWlanSignal struct {
	...
	LinkStatus []*WlanLinkStatus `protobuf:"bytes,1,rep,name=linkStatus,proto3" json:"linkStatus,omitempty"` // sta上报是只有一个
}
...
type MsgFile struct {
	...
	Content      []byte   `protobuf:"bytes,6,opt,name=content,proto3" json:"content,omitempty"`                       // 文件二进制数据
}
...
var file_capwap_proto_rawDesc = []byte{
	...
	0x22, 0xfa, 0x05, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x29, 0x0a, 0x04,
	...
	0x52, 0x0b, 0x68, 0x62, 0x50, 0x65, 0x72, 0x4d, 0x69, 0x6e, 0x75, 0x74, 0x65, 0x22, 0xa5, 0x01,
	0x0a, 0x0b, 0x4d, 0x73, 0x67, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x12, 0x18, 0x0a,
	0x07, 0x64, 0x65, 0x76, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07,
	0x64, 0x65, 0x76, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	...
	,
	...
	,
	...
	0x72, 0x78, 0x52, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x78,
	0x52, 0x61, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x78, 0x52, 0x61, 0x74, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x74, 0x78, 0x52, 0x61, 0x74, 0x65, 0x22, 0x33, 0x0a, 0x05,
	...
	,
	...
	,
	...
	,
}
...
var file_capwap_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_capwap_proto_goTypes = []interface{}{
	...
	(*CfgTag)(nil),           // 12: gbcom.capwap.CfgTag
	(*MsgKeepalive)(nil),     // 13: gbcom.capwap.MsgKeepalive
	(*MsgCfgtags)(nil),       // 14: gbcom.capwap.MsgCfgtags
	...
	(*Usage)(nil),            // 18: gbcom.capwap.Usage
	(*Borad)(nil),            // 19: gbcom.capwap.Borad
	(*MsgHbBoradStatus)(nil), // 20: gbcom.capwap.MsgHbBoradStatus
	(*MsgHbPerMinute)(nil),   // 21: gbcom.capwap.MsgHbPerMinute
	(*WlanLinkStatus)(nil),   // 22: gbcom.capwap.WlanLinkStatus
	(*MsgHbWlanSignal)(nil),  // 23: gbcom.capwap.MsgHbWlanSignal
	(*MsgFile)(nil),          // 24: gbcom.capwap.MsgFile
}
var file_capwap_proto_depIdxs = []int32{
	...
	14, // 9: gbcom.capwap.Message.cfgtags:type_name -> gbcom.capwap.MsgCfgtags
	24, // 10: gbcom.capwap.Message.versionUpgrade:type_name -> gbcom.capwap.MsgFile
	24, // 11: gbcom.capwap.Message.configUpgrade:type_name -> gbcom.capwap.MsgFile
	16, // 12: gbcom.capwap.Message.hbLteSignal:type_name -> gbcom.capwap.MsgHbLteSignal
	23, // 13: gbcom.capwap.Message.hbWlanSignal:type_name -> gbcom.capwap.MsgHbWlanSignal
	20, // 14: gbcom.capwap.Message.hbBoradStatus:type_name -> gbcom.capwap.MsgHbBoradStatus
	21, // 15: gbcom.capwap.Message.hbPerMinute:type_name -> gbcom.capwap.MsgHbPerMinute
	4,  // 16: gbcom.capwap.MsgOnline.status:type_name -> gbcom.capwap.OnlineStatusType
	5,  // 17: gbcom.capwap.CfgTag.type:type_name -> gbcom.capwap.CfgTagType
	12, // 18: gbcom.capwap.MsgKeepalive.CftTag:type_name -> gbcom.capwap.CfgTag
	12, // 19: gbcom.capwap.MsgCfgtags.tags:type_name -> gbcom.capwap.CfgTag
	15, // 20: gbcom.capwap.MsgHbLteSignal.lteMod:type_name -> gbcom.capwap.LteSinal
	18, // 21: gbcom.capwap.Borad.diskUsages:type_name -> gbcom.capwap.Usage
	17, // 22: gbcom.capwap.Borad.portStatistics:type_name -> gbcom.capwap.PortStatistics
	19, // 23: gbcom.capwap.MsgHbBoradStatus.borads:type_name -> gbcom.capwap.Borad
	22, // 24: gbcom.capwap.MsgHbWlanSignal.linkStatus:type_name -> gbcom.capwap.WlanLinkStatus
	6,  // 25: gbcom.capwap.MsgFile.type:type_name -> gbcom.capwap.FileType
	24, // 26: gbcom.capwap.FileTransport.GetFile:input_type -> gbcom.capwap.MsgFile
	24, // 27: gbcom.capwap.FileTransport.GetFile:output_type -> gbcom.capwap.MsgFile
