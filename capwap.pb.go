...
type MsgBoradInfo struct {
	...
	BootVer   string       `protobuf:"bytes,2,opt,name=bootVer,proto3" json:"bootVer,omitempty"`     // boot版本号
	KernelVer string       `protobuf:"bytes,3,opt,name=kernelVer,proto3" json:"kernelVer,omitempty"` // kernel版本号
	FirmVer   string       `protobuf:"bytes,4,opt,name=FirmVer,proto3" json:"FirmVer,omitempty"`     // firmware，与discover消息中携带的设备当前运行版本一致
	LteMods   []*LteModule `protobuf:"bytes,5,rep,name=lteMods,proto3" json:"lteMods,omitempty"`     // 单板上携带的LTE模组信息
}
...
type WlanLinkStatus struct {
	...
	Rsrp     int32  `protobuf:"varint,4,opt,name=rsrp,proto3" json:"rsrp,omitempty"`         // 信号强度
	Rssi     int32  `protobuf:"varint,5,opt,name=rssi,proto3" json:"rssi,omitempty"`         // 信噪比
	RxRate   int32  `protobuf:"varint,6,opt,name=rxRate,proto3" json:"rxRate,omitempty"`     // 协商速率
	TxRate   int32  `protobuf:"varint,7,opt,name=txRate,proto3" json:"txRate,omitempty"`     // 协商速率
	Mac      string `protobuf:"bytes,8,opt,name=mac,proto3" json:"mac,omitempty"`            // sta看到AP的essid-mac，AP看到sta的mac
	Essid    string `protobuf:"bytes,9,opt,name=essid,proto3" json:"essid,omitempty"`        // ap广播的ssid名称，sta接入的apssid名称
}
...
var file_capwap_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2a, 0x17, 0x0a, 0x0a, 0x56, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x62, 0x63, 0x6f,
	0x6d, 0x10, 0x00, 0x2a, 0x4d, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0c,
	...
	,
...
var file_capwap_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_capwap_proto_goTypes = []interface{}{
	...
	(*MsgFile)(nil),          // 28: gbcom.capwap.MsgFile
}
var file_capwap_proto_depIdxs = []int32{
	...
	28, // 10: gbcom.capwap.Message.versionUpgrade:type_name -> gbcom.capwap.MsgFile
	28, // 11: gbcom.capwap.Message.configUpgrade:type_name -> gbcom.capwap.MsgFile
	...
	28, // 29: gbcom.capwap.FileTransport.GetFile:input_type -> gbcom.capwap.MsgFile
	28, // 30: gbcom.capwap.FileTransport.GetFile:output_type -> gbcom.capwap.MsgFile
